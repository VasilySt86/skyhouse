...
(function($) {  
      ...
      defaultsBookingBoxParam: {  
		...
		serverurl:'http://live.ipms247.com/booking/'
      }  
    };  
	...
	var cmnBtn= "<input name='hidBodyLanguage' id='hidBodyLanguage' type='hidden' class='txtbox' value='"+bbBtnConfig.BodyLanguage+"'/>"
		...
		if(bbBtnConfig.showborder==true || bbBtnConfig.showborder=='true') 
		  ...
		  if(bbBtnConfig.Calinit==true || bbBtnConfig.Calinit=='true')
	  		{
                              if (bbBtnConfig.CalMinDate==0 && (typeof(bbBtnConfig.HotelId)!='undefined' && bbBtnConfig.HotelId!='')) //Pinal - 1.0.47.52 - 16 January 2016 - Purpose - Cut off time
                              {
	 ...
	 jQuery("input[id$='eZ_chkin'],input[id$='eZ_chkout'],.ui-datepicker-trigger,.ui-datepicker-next,.ui-datepicker-prev,.ui-datepicker-month,.ui-datepicker-year,#bb_resBtn").live('click', function() {
                     setCalenderCss(bbBtnConfig.CalImage,bbBtnConfig.CalBackColor,bbBtnConfig.CalHeaderColor,bbBtnConfig.headerColor,bbBtnConfig.CalCellActiveColor,bbBtnConfig.CalCellInActiveColor,bbBtnConfig.InputTextColor,bbBtnConfig);
                });
				
				jQuery(".ui-datepicker-month,.ui-datepicker-year").live('change', function() {
                     setCalenderCss(bbBtnConfig.CalImage,bbBtnConfig.CalBackColor,bbBtnConfig.CalHeaderColor,bbBtnConfig.headerColor,bbBtnConfig.CalCellActiveColor,bbBtnConfig.CalCellInActiveColor,bbBtnConfig.InputTextColor,bbBtnConfig);
                });
               ...
               $("input[id$='eZ_chkin'],input[id$='eZ_chkout']").live('focus', function() {
                    setCalenderCss(bbBtnConfig.CalImage,bbBtnConfig.CalBackColor,bbBtnConfig.CalHeaderColor,bbBtnConfig.headerColor,bbBtnConfig.CalCellActiveColor,bbBtnConfig.CalCellInActiveColor,bbBtnConfig.InputTextColor,bbBtnConfig);		   
                });              
...
{
      var param='action=getDefaultDays&HotelId='+HotelId+'&DefaultDays='+CalMinDefaultDate;
      var days=CalMinDefaultDate;
      jQuery.ajax({
            type: "POST",
            async:false,
            url: 'http://live.ipms247.com/booking/service.php',
            data: param, 
